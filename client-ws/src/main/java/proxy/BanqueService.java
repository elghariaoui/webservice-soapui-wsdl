...
public interface BanqueService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "conversionEuroToDhs", targetNamespace = "http://ws/", className = "proxy.ConversionEuroToDhs")
    @ResponseWrapper(localName = "conversionEuroToDhsResponse", targetNamespace = "http://ws/", className = "proxy.ConversionEuroToDhsResponse")
    @Action(input = "http://ws/BanqueService/conversionEuroToDhsRequest", output = "http://ws/BanqueService/conversionEuroToDhsResponse")
